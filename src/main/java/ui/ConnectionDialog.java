...
public class ConnectionDialog extends JDialog {
    ...
    private void probarConexion() {
        ...
        JDialog loadingDialog = new JDialog(this, "Probando...", true);
        ...
        SwingWorker<Boolean, Void> worker = new SwingWorker<>() {
            ...
            protected Boolean doInBackground() {
                return DBManager.probarConexion(temp);
            }
    ...
    private void guardarConexion() {
        ...
        if (exito) {
            ...
            JOptionPane.showMessageDialog(this, "Error al guardar la conexión", "Error", JOptionPane.ERROR_MESSAGE);
        }
    }
